...
@onready var cooldown_time: float = get_node("/root/Config").get_value("cooldown", "dummy")
...
@onready var power: float = get_node("/root/Config").get_value("power", "dummy")
@onready var speed: float = get_node("/root/Config").get_value("speed", "dummy")
